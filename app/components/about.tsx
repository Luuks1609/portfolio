...
export default function About() {
	return (
		<div className="py-4">
			<p className="">
				My work varies from developing my startup ideas, building websites for freelance
				clients, or creating fun side projects. I&apos;m always looking for new
			...
			<div className="space-y-3">
				<p>
					My journey into technology began with a degree in Application and Media
					Development at mboRijnland in my hometown Zoetermeer.
				</p>
				<p>
					Inspired by the possibilities of software development, I pursued further studies
					at The Hague University of Applied Sciences, specializing in Software
					Engineering.
				</p>
			</div>
			<Languages />
